    ...
    if (isHome) {
      Object.assign(primarySchema, {
        ...
        featureList: [
          ...
          "Dictionary-based compression (Dictionary/DictionaryBuilder)",
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "CompressionOptions", link: "/api/compress-options" },
          { text: "DecompressionOptions", link: "/api/decompress-options" },
          { text: "CompressionContext", link: "/api/compressor" },
          { text: "DecompressionContext", link: "/api/decompressor" },
          { text: "StreamingCompressor", link: "/api/stream-compressor" },
          { text: "StreamingDecompressor", link: "/api/stream-decompressor" },
          { text: "Dictionary / DictionaryBuilder", link: "/api/dict" },
          { text: "FrameHeader", link: "/api/frame" },
          { text: "Strategy", link: "/api/clevel" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Basic Compression", link: "/examples/basic_compression" },
          { text: "Basic Decompression", link: "/examples/basic_decompression" },
          { text: "Custom Level", link: "/examples/custom_level" },
          { text: "Advanced Params", link: "/examples/advanced_params" },
          { text: "Dictionary Compression", link: "/examples/dictionary_compression" },
          { text: "Dictionary Training", link: "/examples/dictionary_training" },
          { text: "Streaming Compression", link: "/examples/streaming_compression" },
          { text: "Streaming Decompression", link: "/examples/streaming_decompression" },
          { text: "Custom Allocator", link: "/examples/custom_allocator" },
          { text: "Error Handling", link: "/examples/error_handling" },
          { text: "Legacy Decompression", link: "/examples/legacy_decompression" },
          { text: "File Compression", link: "/examples/file_compression" },
        ],
      },
    ],
