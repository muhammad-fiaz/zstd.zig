...
description: Corruption, truncation and buffer error handling.
---
...
```text
Correctly caught error: PrefixUnknown
Truncated correctly failed: SrcSizeWrong
Small buffer correctly failed: DstSizeTooSmall
